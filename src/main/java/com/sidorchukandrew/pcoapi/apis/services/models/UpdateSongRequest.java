...
public class UpdateSongRequest implements UpdateRequest {
    ...
    private UpdateSongRequest(Builder builder) {
        title = builder.title;
        admin = builder.admin;
    ...
    public static class Builder {
        ...
        public UpdateSongRequest build() {
